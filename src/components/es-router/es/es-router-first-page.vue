...
export default defineComponent({
  ...
  setup() {
    console.log("-----router------第一个页面---setup---生命周期--->>>>" + new Date().getTime());
    ...
    function onESCreate(params) {
      ...
      console.log("---第一个页面---onESCreate---生命周期--->>>>" + "ref:", routerRootView, params);
    }
    ...
    function onESRestoreInstanceState(savedInstanceState) {
      ...
      console.log(
        "---第一个页面---onESRestoreInstanceState---生命周期--->>>>" + "ref:",
        routerRootView,
        savedInstanceState,
      );
    }
    ...
    function onESSaveInstanceState(savedInstanceState) {
      ...
      console.log(
        "---第一个页面---onESSaveInstanceState---生命周期--->>>>" + "ref:",
        routerRootView,
        savedInstanceState,
      );
    }
