...
export default defineComponent({
  ...
  setup() {
    ...
    function onPlayerPlayMediaSourceList(mediaSourceList: ESMediaSourceList): void {
      contentText.value =
        contentText.value + "onPlayerPlayMediaSourceList:" + JSON.stringify(mediaSourceList) + "\n";
    }

    function onPlayerPlayMediaSource(mediaSource: ESMediaSource): void {
      contentText.value =
        contentText.value + "onPlayerPlayMediaSource:" + JSON.stringify(mediaSource) + "\n";
    }

    function onPlayerInterceptSuccess(value: ESPlayerInterceptResult): void {
      contentText.value =
        contentText.value + "onPlayerInterceptSuccess:" + JSON.stringify(value) + "\n";
    }

    function onPlayerInterceptError(value: ESPlayerInterceptError): void {
      contentText.value =
        contentText.value + "onPlayerInterceptError:" + JSON.stringify(value) + "\n";
    }
    ...
    function onPlayerVolumeChanged(leftVolume: number, rightVolume: number): void {
      contentText.value =
        contentText.value + "onPlayerVolumeChanged:" + leftVolume + " " + rightVolume + "\n";
    }
    ...
    function onPlayerDefinitionListChanged(definitionList: Array<ESPlayerDefinition>): void {
      contentText.value =
        ...
        JSON.stringify(definitionList) +
        "\n";
    }

    function onPlayerDefinitionChanged(definition: ESPlayerDefinition): void {
      contentText.value =
        contentText.value + "onPlayerDefinitionChanged:" + JSON.stringify(definition) + "\n";
    }

    function onPlayerPlayRateListChanged(rateList: Array<ESPlayerRate>): void {
      contentText.value =
        contentText.value + "onPlayerPlayRateListChanged:" + JSON.stringify(rateList) + "\n";
    }

    function onPlayerPlayRateChanged(rate: ESPlayerRate): void {
      contentText.value =
        contentText.value + "onPlayerPlayRateChanged:" + JSON.stringify(rate) + "\n";
    }

    function onPlayerDecodeListChanged(decodeList: Array<ESPlayerDecode>): void {
      contentText.value =
        contentText.value + "onPlayerDecodeListChanged:" + JSON.stringify(decodeList) + "\n";
    }

    function onPlayerDecodeChanged(decode: ESPlayerDecode): void {
      contentText.value =
        contentText.value + "onPlayerDecodeChanged:" + JSON.stringify(decode) + "\n";
    }
    ...
    function onPlayerAspectRatioListChanged(aspectRatioList: Array<ESPlayerAspectRatio>): void {
      contentText.value =
        ...
        JSON.stringify(aspectRatioList) +
        "\n";
    }

    function onPlayerAspectRatioChanged(aspectRatio: ESPlayerAspectRatio): void {
      contentText.value =
        contentText.value + "onPlayerAspectRatioChanged:" + JSON.stringify(aspectRatio) + "\n";
    }
    ...
    function onPlayerPlayMediaSourceListModeChanged(mode: ESPlayerPlayMode): void {
      contentText.value =
        contentText.value + "onPlayerPlayMediaSourceListModeChanged:" + JSON.stringify(mode) + "\n";
    }
    ...
    function onPlayerSizeChanged(playerWidth: number, playerHeight: number): void {
      contentText.value =
        contentText.value + "onPlayerSizeChanged:" + playerWidth + " " + playerHeight + "\n";
    }
    ...
    function onPlayerPlayMediaList(playList: ESMediaItemList): void {
      contentText.value =
        contentText.value + "onPlayerPlayMediaList:" + JSON.stringify(playList) + "\n";
    }

    function onPlayerPlayMedia(mediaItem: ESMediaItem): void {
      contentText.value =
        contentText.value + "onPlayerPlayMedia:" + JSON.stringify(mediaItem) + "\n";
    }
    ...
    function onPlayerWindowTypeChanged(windowType: ESPlayerWindowType): void {
      contentText.value =
        contentText.value + "onPlayerWindowTypeChanged:" + JSON.stringify(windowType) + "\n";
    }

    function onPlayerWindowSizeChanged(playerWidth: number, playerHeight: number): void {
      contentText.value =
        contentText.value + "onPlayerWindowSizeChanged:" + playerWidth + " " + playerHeight + "\n";
    }
