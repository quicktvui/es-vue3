...
import es_video_player_page_page from "./es-video-player-page-page";
import es_video_player_adapt_page from "./es-video-player-adapt-page.vue";
import es_video_player_meta_page from "./es-video-player-meta-page.vue";
...
const ESVideoPlayerPageList = {
  ...
  es_video_player_page_page: {
    name: "页面播放控制",
    component: es_video_player_page_page,
  },
  es_video_player_adapt_page: {
    name: "自适应码率",
    component: es_video_player_adapt_page,
  },
  es_video_player_meta_page: {
    name: "视频信息",
    component: es_video_player_meta_page,
  },
};
