<template>
  <div class="es-sdk-slot-root-css es-sdk-slot-purple-root-css">
    ...
    <div class="es-sdk-content-column-css">
      ...
      <s-text-view
        :text="'androidAPILevel：' + androidAPILevel + '   buildSDKVersion：' + buildSDKVersion"
      ></s-text-view>
      <s-text-view
        :text="'totalMemory：' + totalMemory + '   availMemory：' + availMemory"
      ></s-text-view>
      <s-text-view
        :text="'screenWidth：' + screenWidth + '   screenHeight：' + screenHeight"
      ></s-text-view>
      <s-text-view
        :text="'deviceEthMac：' + deviceEthMac + '   deviceWifiMac：' + deviceWifiMac"
      ></s-text-view>
      ...
      ></s-text-view>
      <s-text-view
        :text="'buildProduct：' + buildProduct + '   buildHardware：' + buildHardware"
      ></s-text-view>
    </div>
  </div>
</template>
