...
declare const __ES_VUE_FEATURE_FLAGS__: Partial<{
  ENABLE_KEY_EVENT_DISPATCH: boolean;
  ENABLE_EVENT_BUBBLE: boolean;
}>;
...
declare namespace HippyTypes {
  ...
  export type alignSelf = "stretch" | "center" | "flex-start" | "flex-end" | "baseline";
  ...
  export type TranslatedNodes = [NativeNode, ReferenceInfo] | NativeNode;
...
declare type Diff<T extends keyof any, U extends keyof any> = ({ [P in T]: P } & {
  [P in U]: never;
} & { [x: string]: never })[T];
