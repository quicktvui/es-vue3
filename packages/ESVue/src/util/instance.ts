...
import type { App, ComponentPublicInstance } from "@vue/runtime-core";
 ...
 * @param value - value
 */
export function setHippyCachedInstanceParams<K extends keyof HippyCachedInstanceType>(
  key: K,
  value: HippyCachedInstanceType[K],
): void {
