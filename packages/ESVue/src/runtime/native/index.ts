...
import type {CallbackType, NativeInterfaceMap, NeedToTyped} from '../../types';
import {HIPPY_VUE_VERSION, NATIVE_COMPONENT_MAP} from '../../config';
...
type CallNativeFunctionSignature<K extends keyof NativeInterfaceMap,
...
export interface NativeApiType {
  ...
  callNativeWithCallbackId: <K extends keyof NativeInterfaceMap,
    T extends keyof NativeInterfaceMap[K],
    >(
    moduleName: K,
    methodName: T,
