...
export class HippyEvent {
  ...
  public bubbles =
    (typeof __ES_VUE_FEATURE_FLAGS__ !== "undefined" &&
      __ES_VUE_FEATURE_FLAGS__.ENABLE_EVENT_BUBBLE) ??
    false;
...
export class BindEvent extends HippyEvent {
  // whether the current input box has the focus
...
export class HippyScrollOffsetEvent extends HippyEvent {
  x?: number;
  y?: number;
  offsetX?: number;
  offsetY?: number;
...
export class HippyScrollStateChangedEvent extends HippyScrollOffsetEvent {
  oldState?: number;
  newState?: number;
}

export class HippyChildFocusEvent extends HippyEvent {
  child?: HippyEventChild;
  focused?: HippyEventChild;
}

export class HippyChildSelectEvent extends HippyEvent {
  child?: HippyEventChild;
}

export class HippyFocusSearchFailedEvent extends HippyEvent {
  child?: HippyEventChild;
  direction?: number;
  focused?: HippyEventChild;
}

export class HippyEventChild {
  index?: number;
  id?: number;
  name?: number;
  position?: number;
...
export interface HippyGlobalEventHandlersEventMap {
  ...
  onFocus: FocusEvent;
  onBindItem: BindEvent;
  onUnbindItem: BindEvent;
  ...
  //-----------add by liulipeng-----------------------------
  onScrollOffset: HippyScrollOffsetEvent;
  onScrollStateChanged: HippyScrollStateChangedEvent;
  onChildFocus: HippyChildFocusEvent;
  onChildSelect: HippyChildSelectEvent;
  onFocusSearchFailed: HippyFocusSearchFailedEvent;
  //-----------add by liulipeng-----------------------------
}
