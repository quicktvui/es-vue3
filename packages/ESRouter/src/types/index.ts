...
import {Component, ComponentPublicInstance, DefineComponent, Ref} from 'vue'
import {ESRouteLaunchMode, ESRouteType, RouteRecord, RouteRecordNormalized} from '../matcher/types'
import {HistoryState} from '../history/common'
import {NavigationFailure} from '../errors'
import {ESNativeRouterLaunchMode} from "../es/ESNativeRouterLaunchMode";
import {ESNativeRouterSplash} from "../es/ESNativeRouterSplash";
import {RouteResultCallback} from "../result/RouteResultCallback";
...
export type RouteParamsRaw = Record<string,
...
export interface NativeRouteLocationRaw {
  pkg?: string,
  args?: RouteLocationRaw,
  flags?: ESNativeRouterLaunchMode,
  pageTag?: string,
  pageLimit?: number,
  backgroundColor?: string | number,
  splash?: ESNativeRouterSplash,
  version?: string
  minVersion?: string
  isCard?: boolean
  transparent?: boolean
...
export interface RouteLocationUrlRaw {
  url?: RouteRecordName
  params?: RouteParamsRaw
}
...
export interface _RouteRecordBase extends PathParserOptions {
  ...
  /**
   *  standard | singleTask | clearTask | clearTop
   */
  launchMode?: ESRouteLaunchMode

  /**
   *  ES_ROUTE_TYPE_PAGE | ES_ROUTE_TYPE_DIALOG
   */
  type: ESRouteType
}
