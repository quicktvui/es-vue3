...
declare module '@vue/runtime-core' {
  ...
  export interface GlobalComponents {
    EsRouterView: TypesConfig extends Record<'RouterView', infer T>
      ? T
      : typeof RouterView
    EsRouterLink: TypesConfig extends Record<'RouterLink', infer T>
      ? T
      : typeof RouterLink
    EsSlotView: TypesConfig extends Record<'SlotView', infer T>
      ? T
      : typeof SlotView
  }
}
