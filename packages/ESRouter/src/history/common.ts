...
import { LifecycleState } from "../matcher/types";
...
export interface HistoryLocation {
  ...
  instances?: ComponentPublicInstance | undefined | null;
...
export interface RouterHistory {
   ...
   * the history
   */
  go(delta: number, triggerListeners?: boolean): boolean;
   ...
   * @param data
   */
  splice(to: HistoryLocation, data?: HistoryState): boolean;
