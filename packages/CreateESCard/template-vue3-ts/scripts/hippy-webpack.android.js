...
module.exports = {
  ...
  resolve: {
    ...
    //   // if (fs.existsSync(path.resolve(componentPath, 'index.js'))) {
    ...
    //   // if (fs.existsSync(path.resolve(routerPath, 'index.js'))) {
    ...
    //   // if (fs.existsSync(path.resolve(styleParserPath, 'index.js'))) {
