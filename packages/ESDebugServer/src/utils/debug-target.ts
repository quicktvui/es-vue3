...
export const createTargetByDeviceInfo = (device: DeviceInfo): DebugTarget => {
  ...
  info(' createTargetByDeviceInfo', device)
  ...
  info('createTargetByDeviceInfo makeUrl', wsUrl)
  ...
  info('createTargetByDeviceInfo devtoolsFrontendUrl', devtoolsFrontendUrl)

  const title = device.platform === DevicePlatform.IOS ? clientId : 'QuickTVUI debug tools for V8';
...
export const createTargetByWsUrlParams = (wsUrlParams: AppWsUrlParams, host: string): DebugTarget => {
  ...
  info(' createTargetByWsUrlParams wsUrlParams:', wsUrlParams)
  ...
  info(' createTargetByWsUrlParams wsUrl:', wsUrl)
  ...
  info(' createTargetByWsUrlParams devtoolsFrontendUrl:', devtoolsFrontendUrl)
...
export const createTargetByIWDPPage = (iWDPPage: IWDPPage): DebugTarget => {
  ...
  info(' createTargetByIWDPPage iWDPPage:', iWDPPage)
  ...
  info(' createTargetByIWDPPage wsUrl:', wsUrl)
  ...
  info(' createTargetByIWDPPage devtoolsFrontendUrl:', devtoolsFrontendUrl)
