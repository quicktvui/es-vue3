...
class ESDynamicImportPlugin {
  ...
  applyV4(compiler) {
    ...
    compiler.hooks.make.tapAsync('ESDynamicImportPlugin', (compilation, callback) => {
  ...
  applyV5(compiler) {
    ...
    compiler.hooks.compilation.tap(
      ESDynamicImportPlugin.name,
      (compilation) => {
        // inject __webpack_require__.l
        compilation.hooks.runtimeRequirementInTree
          .for(RuntimeGlobals.loadScript)
          .tap({
            name: ESDynamicImportPlugin.name,
...
module.exports = ESDynamicImportPlugin;
