/*
  ...
  modify base on https://github.com/webpack/webpack/blob/v5.36.2/lib/web/JsonpChunkLoadingRuntimeModule.js
  add __DYNAMIC_LOAD_CUSTOM_PATH_MAP__ to support custom sub-bundle publicPath
*/
      ...
      withLoading
        ? Template.asString([
          `${fn}.j = ${runtimeTemplate.basicFunction(
            ...
            hasJsMatcher !== false
              ? Template.indent([
                "// JSONP chunk loading for hippy javascript",
                ...
                Template.indent([
                  ...
                  Template.indent([
                    ...
                    Template.indent([
                      ...
                      `if (url && global.__DYNAMIC_LOAD_CUSTOM_PATH_MAP__) {`,
                      Template.indent([
                        `var isSchema = ['https://', 'http://', '//'].some(schema => url.indexOf(schema) === 0);`,
                        `if(isSchema) {`,
                        Template.indent([
                          ...
                          `if(customChunkPath) url = customChunkPath + chunkAllName;`,
                        ]),
                        `} else {`,
                        Template.indent([
                          `var chunkName = url.split('.')[0];`,
                          ` var customChunkPath = global.__DYNAMIC_LOAD_CUSTOM_PATH_MAP__[chunkName];`,
                          `if(customChunkPath) url = customChunkPath + url;`
                        ]),
                        `}`,
                      ]),
                      `}`,
